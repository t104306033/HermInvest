...
func main() {
	...
	_, err = db.Exec(`
		...
		(1, '0050', '2023-12-04', 1, 1, 20, 20, 3),
		(2, '0050', '2023-12-05', 1, 1, 20, 20, 3),
		(3, '0050', '2023-12-06', 1, 1, 20, 20, 3),
		(4, '0051', '2023-12-06', 1, 1, 20, 20, 3),
		(5, '0051', '2023-12-06', 1, 1, 20, 20, 3),
		(6, '0051', '2023-12-06', 1, 1, 20, 20, 3),
		(7, '0052', '2023-12-06', 1, 1, 20, 20, 3),
		(8, '0052', '2023-12-06', 1, 1, 20, 20, 3),
		(9, '0052', '2023-12-06', 1, 1, 20, 20, 3),
		(10, '0052', '2023-12-06', 1, 1, 20, 20, 3)
	`)
	if err != nil {
		fmt.Println(err)
	}
